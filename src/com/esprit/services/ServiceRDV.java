...
public class ServiceRDV {
    ...
    public boolean addRDV(RDV r) {
        String url = Statics.BASE_URL + "/rdvnew?nom=\"" + r.getNom() + "\"&nommed=\"" + r.getNommed()+ "\"&date=\"" + r.getDate()+"\""; //création de l'URL
    ...
    public ArrayList<RDV> parseRDV(String jsonText){
        ...
        */
        ...
        String url = Statics.BASE_URL+"/rdv/users";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    //code recherche
//    public ArrayList<RDV> findAll(String nommed) {
//        String url = Statics.BASE_URL + "rdv/"+nommed;
//        req.setUrl(url);
//        req.setPost(false);
//        req.addResponseListener(new ActionListener<NetworkEvent>() {
//            @Override
//            public void actionPerformed(NetworkEvent evt) {
//                rdvs = parsePanier(new String(req.getResponseData()));
//                req.removeResponseListener(this);
//            }
//        });
//        NetworkManager.getInstance().addToQueueAndWait(req);
