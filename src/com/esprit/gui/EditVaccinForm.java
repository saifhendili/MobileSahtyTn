 ...
 * @author Lenovo
 */
public class EditVaccinForm extends BaseForm {
    
    Form current;
    public EditVaccinForm(Resources res , Vaccin r) {
...
//        
       ...
       if(ServiceVaccin.getInstance().EditVaccin(r)) { // if true
